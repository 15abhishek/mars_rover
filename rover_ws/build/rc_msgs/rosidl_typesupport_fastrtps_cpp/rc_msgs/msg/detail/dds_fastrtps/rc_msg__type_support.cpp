...
#include "rc_msgs/msg/detail/rc_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rc_msgs::msg::RcMsg;
    is_plain =
      (
...
static size_t _RcMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RcMsg(full_bounded, is_plain, 0);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_rc_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<rc_msgs::msg::RcMsg>()
{
  return &rc_msgs::msg::typesupport_fastrtps_cpp::_RcMsg__handle;
}
