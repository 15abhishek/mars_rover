...
bool rc_msgs__msg__rc_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rc_msgs.msg._rc_msg.RcMsg", full_classname_dest, 25) == 0);
  }
  rc_msgs__msg__RcMsg * ros_message = _ros_message;
  {  // arm
  ...
  {  // throttle
    ...
    ros_message->throttle = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // steer
  ...
  {  // op_mode
    ...
    assert(PyLong_Check(field));
    ros_message->op_mode = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of RcMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rc_msgs.msg._rc_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RcMsg");
  ...
  {  // op_mode
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->op_mode);
    {
